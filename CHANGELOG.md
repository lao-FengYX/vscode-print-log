# Change Log
### 1.0.16
- [fix] 单参数(没有括号)匿名函数 打印行错误问题

### 1.0.15
- [fix] 选择打印文本, 匹配函数忘记考虑函数前面内容(通常指函数名)的情况
...
### 1.0.12
- [fix] 打印赋值表达式(数组调用方法的情况) 左侧文本打印行错误的问题
...
### 1.0.3
- [fix] 修复选择分号输出后, 光标移动位置错误的问题
- [fix] 修复选择分号输出后, 未输出分号的问题

### 1.0.2
- [fix] 匹配`console`调用换行的情况
